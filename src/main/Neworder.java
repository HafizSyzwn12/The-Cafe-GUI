...
public class Neworder extends JFrame {
	...
	public Neworder(String orderid) throws IOException {
		...
		regularcustomercheck.setBackground(new Color(160, 82, 45));
		regularcustomercheck.setForeground(new Color(255, 255, 255));
		...
		malevalueradio.setForeground(new Color(255, 255, 255));
		malevalueradio.setBackground(new Color(160, 82, 45));
		JRadioButton femalevalueradio = new JRadioButton("Female");
		femalevalueradio.setForeground(new Color(255, 255, 255));
		femalevalueradio.setBackground(new Color(160, 82, 45));
