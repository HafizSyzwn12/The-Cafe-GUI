...
public class PaymentPage extends JFrame {
	 ...
	 * Create the frame.
	 */
	public PaymentPage(String orderid, double payment) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(PaymentPage.class.getResource("/main/logo/logo.png")));
		...
		lblPayment.setIcon(new ImageIcon(PaymentPage.class.getResource("/main/logo/mobile-payment.png")));
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(process == true) {
					Main.getpayment().add(new Payment(orderid, paymenttype, payment, custpayvalue));
